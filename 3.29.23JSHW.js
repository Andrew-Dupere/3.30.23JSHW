...
function printMovieInfo(movietitle){
    ...
    .then(movietitle => console.log(`${movietitle.title} by ${movietitle.director} a story of ${movietitle.description} that runs for ${movietitle.runtime} minutes`))
